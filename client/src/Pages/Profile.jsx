...
const Leaderboards = lazy(() => import('../Components/Leaderboards.jsx')); // "wait" for Leaderboards.jsx to load

// A page to display the profile of the user's account
function Profile(){
    ...
    // A function to handle updating the user's chosen avatar
    ...
    // Original user account information
    ...
    // Function to revert changes if the user chooses to cancel the changes they made to their account
